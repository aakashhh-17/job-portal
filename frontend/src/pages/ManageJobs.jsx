    ...
    <div className='container p-4 max-w-5xl'>
      <div className='overflow-x-auto'>
        <table className='min-w-full bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr>
              <th className='py-2 px-4 text-left border-b border-gray-200 max-sm:hidden'>#</th>
              <th className='py-2 px-4 text-left border-b border-gray-200'>Job Title</th>
              <th className='py-2 px-4 text-left border-b border-gray-200 max-sm:hidden'>Date</th>
              <th className='py-2 px-4 text-left border-b border-gray-200 max-sm:hidden'>Location</th>
              <th className='py-2 px-4 text-center border-b border-gray-200'>Applicants</th>
              <th className='py-2 px-4 text-left border-b border-gray-200'>Visible</th>
            </tr>
          </thead>
          <tbody>
